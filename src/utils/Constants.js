...
export const TOTAL_FILTER_CONSTANT = 'filterList';
export const JWT_TOKEN_CONSTANT = 'jwtViaRefToken';
export const LIST_ADDRESS_CONSTANT = 'listAddress';
export const ADD_ADDRESS_CONSTANT = 'addAddress';
export const EDIT_ADDRESS_CONSTANT = 'editAddress';
...
export const ADD_TO_CART_CONSTANT = 'addToCart';
export const GET_ITEMS_IN_CART_CONSTANT = 'productsInCart';
export const VIEW_ITEMS_IN_CART_CONSTANT = 'viewCart';
export const DELETE_ITEMS_IN_CART_CONSTANT = 'deleteFromCart';
...
export const EMAIL_OR_MOBILE_LABEL = "Enter your email or phone number";
export const EMAIL_LABEL = "userPhoneOrEmail";
export const PASSWORD_LABEL = "Enter your password";
